...
routerClient.post('/searchName/', async(req, res) => {
    try {
        ...
        console.error("Error in searchName:", err);
...
routerClient.post('/getUserPage/', async(req, res) => {
    try {
        ...
        console.error("Error in getUserPage:", err);
        res.status(500).send("Server Error");
    }
});
...
routerClient.post('/userAutoLogout/', async(req, res) => {
    try {
        ...
        console.error("Error in userAutoLogout:", err);
        res.status(500).send("Server Error");
    }
});
...
routerClient.post('/changeNick/', validatorClient(), async(req, res) => {
    try {
        ...
        console.error("Error in changeNick:", err);
        res.status(500).send("Server Error");
    }
});
//------------------------CLIENT USER ACTIONS-------------------//
...
routerClient.post('/requestOrderPage/', async(req, res) => {
    try {
        ...
        console.error("Error in requestOrderPage:", err);
        res.status(500).send("Server Error");
    }
});
...
routerClient.post('/placeOrder/', async function(req, res) {
    try {
        ...
        loggedUserDetails = await db.dbGetClientDetailsById(userId);
        let orderResult;
        orderResult = await db.dbInsertOrderToOrders(orderTime, userId, orderInfo, orderPriceSum);
        let orderClient;
        orderClient = await db.dbInsertOrderToClient(orderTime, userId, orderPriceSum);
        ordersLogger.order(`
            time: ${orderTime} 
            user: ${userId} 
            sum: ${orderPriceSum} 
...
routerClient.post('/deleteLastOrderConfirm/', async(req, res) => {
    try {
        ...
        console.error("Error in deleteLastOrderConfirm:", err);
        res.status(500).send("Server Error");
    }
});
...
routerClient.post('/deleteLastOrder/', async(req, res) => {
    try {
        ...
        console.error("Error in deleteLastOrder:", err);
        res.status(500).send("Server Error");
    }
});
...
routerClient.post('/getDisplayInfo/', async(req, res) => {
    try {
        ...
        console.error("Error in getDisplayInfo:", err);
        res.status(500).send("Server Error");
    }
});
